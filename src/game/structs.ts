...
export const STRUCTS: Record<StructType, StructDef> = {
  ...
  gas: { size: 3, cost: 4500, upkeep: 15, power: 300, pollution: 25, pollutionRadius: 5, category: 'power' },
  nuclear: { size: 4, cost: 15000, upkeep: 50, power: 1500, category: 'power' },
  ...
  police: { size: 3, cost: 500, upkeep: 10, radius: 10, consumes: 1, dept: 'police', category: 'service' },
  fire: { size: 3, cost: 500, upkeep: 10, radius: 10, consumes: 1, dept: 'fire', category: 'service' },
  school: { size: 3, cost: 400, upkeep: 8, radius: 12, consumes: 1, dept: 'education', category: 'service' },
  hospital: { size: 3, cost: 800, upkeep: 12, radius: 12, consumes: 1, dept: 'health', category: 'service' },
  park: { size: 1, cost: 20, upkeep: 0.5, radius: 3, category: 'park' },
  bigpark: { size: 3, cost: 150, upkeep: 2, radius: 5, category: 'park' },
  station: { size: 2, cost: 500, upkeep: 8, consumes: 1, category: 'transport' },
  bus: { size: 2, cost: 300, upkeep: 10, radius: 12, consumes: 1, category: 'transport' },
  port: { size: 3, cost: 5000, upkeep: 40, consumes: 2, category: 'transport', needsShore: true },
  airport: { size: 4, cost: 10000, upkeep: 80, consumes: 3, pollution: 20, pollutionRadius: 5, category: 'transport' },
