...
const D: Record<string, [string, string]> = {
  ...
  'struct.wind.desc': ['8 MW, propre, prend de la place. En mer : 12 MW.', '8 MW, clean, takes room. At sea: 12 MW.'],
  ...
  'struct.nuclear.desc': ['1 500 MW, aucune pollution. Un séisme proche peut la faire céder.', '1,500 MW, no pollution. A nearby earthquake may wreck it.'],
  'struct.fusion': ['Centrale à fusion', 'Fusion plant'],
  'struct.fusion.desc': ['6 000 MW, propre, insensible aux séismes. En vaut quatre nucléaires.', '6,000 MW, clean, earthquake-proof. Worth four nuclear plants.'],
  ...
  'btn.flat': ['Vue à plat : immeubles et équipements en emprise au sol, pour atteindre ce qui est caché derrière (V)', 'Flat view: buildings and facilities as footprints, to reach what hides behind them (V)'],
  ...
  'mapkind.coast': ['Côte', 'Coast'],
  'mapkind.river': ['Rivière', 'River'],
  'mapkind.lakes': ['Lacs', 'Lakes'],
  'mapkind.islands': ['Archipel', 'Islands'],
  'mapkind.mountain': ['Montagne', 'Mountains'],
  ...
  'reason.bridgeJunction': ['Pas d\'embranchement ni de carrefour sur un pont.', 'No junction on a bridge.'],
  ...
  'log.meltdown': ['La centrale nucléaire a cédé sous le séisme : le quartier est dévasté.', 'The nuclear plant failed in the earthquake: the district is wrecked.'],
